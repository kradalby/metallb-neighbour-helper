// THIS FILE IS COPIED FROM https://github.com/danderson/metallb/blob/master/internal/config/config.go
...
package metallb-config // import "go.universe.tf/metallb/internal/config"
